module ApplicationHelper
  ...
  def svg_icon(path_data)
    %Q(<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="#{path_data}" /></svg>).html_safe
  end
  ...
  def workspace_nav_items(user)
    ...
    items = [
      { title: "Home", subtitle: "Workspace overview", href: home_path, icon: svg_icon("M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25"), keywords: %w[home workspace dashboard overview], group: "workspace" },
      { title: "Boards", subtitle: "All workspaces", href: boards_path, icon: svg_icon("M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25"), keywords: %w[boards workspace kanban], group: "workspace" },
      { title: "Agents", subtitle: "Fleet status and controls", href: agents_path, icon: svg_icon("M8.25 3v1.5M4.5 3A2.25 2.25 0 006.75 5.25v14.25a2.25 2.25 0 002.25 2.25h6.75a2.25 2.25 0 002.25-2.25V5.25A2.25 2.25 0 0015.75 3h-7.5zM19.5 12h.008v.008H19.5V12zm-.375 0h.008v.008H19.125V12z"), keywords: %w[agents agent fleet status controls], group: "operations" },
      { title: "Skills", subtitle: "Reusable knowledge blocks", href: skills_path, icon: svg_icon("M14.25 9.75L16.5 12l-2.25 2.25m-4.5 0L7.5 12l2.25-2.25M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z"), keywords: %w[skills skill knowledge reusable blocks], group: "operations" },
      { title: "Workflows", subtitle: "Trigger runs and automation", href: workflows_path, icon: svg_icon("M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z"), keywords: %w[workflows workflow triggers runs automation], group: "operations" },
      { title: "Handoffs", subtitle: "Transfer templates", href: handoff_templates_path, icon: svg_icon("M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5"), keywords: %w[handoffs handoff transfer templates], group: "operations" },
      { title: "Routing", subtitle: "Auto-routing rules", href: routing_rules_path, icon: svg_icon("M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.18.324.283.696.283 1.093s-.103.77-.283 1.093m0-2.186l9.566-5.314m-9.566 7.5l9.566 5.314m0 0a2.25 2.25 0 103.935 2.186 2.25 2.25 0 00-3.935-2.186zm0-12.814a2.25 2.25 0 103.933-2.185 2.25 2.25 0 00-3.933 2.185z"), keywords: %w[routing auto-routing rules router], group: "operations" },
      { title: "Presets", subtitle: "Reusable command presets", href: command_presets_path, icon: svg_icon("M6.75 7.5l3 2.25-3 2.25m4.5 0H21m-9.5-6h4.5a2.25 2.25 0 012.25 2.25v6.75a2.25 2.25 0 01-2.25 2.25h-6.75a2.25 2.25 0 01-2.25-2.25V9.75A2.25 2.25 0 016.75 7.5z"), keywords: %w[presets preset commands command reusable], group: "operations" },
      { title: "Settings", subtitle: "Profile and OpenClaw integration", href: settings_path, icon: svg_icon("M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.325.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 011.37.49l1.296 2.247a1.125 1.125 0 01-.26 1.431l-1.003.827c-.293.241-.438.613-.43.992a7.723 7.723 0 010 .255c-.008.378.138.75.43.992l1.004.827c.424.35.534.955.26 1.43l-1.298 2.247a1.125 1.125 0 01-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.47 6.47 0 01-.22.128c-.331.183-.581.495-.644.869l-.213 1.281c-.09.543-.56.94-1.11.94h-2.594c-.55 0-1.019-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 01-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 01-1.369-.49l-1.297-2.247a1.125 1.125 0 01.26-1.431l1.004-.827c.292-.24.437-.613.43-.991a6.932 6.932 0 010-.255c.007-.38-.138-.751-.43-.992l-1.004-.827a1.125 1.125 0 01-.26-1.43l1.297-2.247a1.125 1.125 0 011.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.086.22-.128.332-.183.582-.495.644-.869l.214-1.28Z M15 12a3 3 0 11-6 0 3 3 0 016 0z"), keywords: %w[settings profile openclaw integration api token], group: "system" }
    ]

    if user.admin?
      items << { title: "Audit Logs", subtitle: "Admin activity trail", href: admin_audit_logs_path, icon: svg_icon("M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z"), keywords: %w[audit logs admin activity trail], group: "system" }
    end
